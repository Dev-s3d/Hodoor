...
$date_from = clsHelper::get('date_from', date('Y-m-d', strtotime('-6 days')));
$date_to = clsHelper::get('date_to', date('Y-m-d'));
...
<?php require_once '../../includes/sidebar.php'; ?>
    ...
    <div class="main-content w-100">
        ...
        <div class="content p-4">
            ...
            <div class="mb-4">
                <h1 class="mb-1">التقرير الأسبوعي</h1>
                <p class="text-muted mb-0">عرض حضور أسبوعي حسب الفترة والفصل</p>
            </div>
